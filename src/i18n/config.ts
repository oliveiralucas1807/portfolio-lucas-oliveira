...
export const ui = {
  pt: {
    ...
    projectsEyebrow: 'Projetos', projectsTitle: 'Campanhas e soluções visuais para marcas em movimento.', projectsIntro: 'Cada projeto apresenta contexto, direção visual e entregas desenvolvidas para necessidades reais de comunicação.',
    ...
    deepTitle: 'Cases de desenvolvimento e processo', deepText: 'Este futuro ambiente vai reunir estudos, testes, automações e decisões por trás dos projetos. Uma visão mais completa de como cada solução é construída.', deepAction: 'Conhecer a proposta',
  ...
  en: {
    ...
    projectsEyebrow: 'Projects', projectsTitle: 'Campaigns and visual solutions for brands in motion.', projectsIntro: 'Each project presents context, visual direction and deliverables developed for real communication needs.',
    ...
    deepTitle: 'Development and process cases', deepText: 'This future space will bring together studies, tests, automation and the decisions behind the projects. A fuller view of how each solution is built.', deepAction: 'View the proposal',
